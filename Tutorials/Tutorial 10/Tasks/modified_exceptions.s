...
__m3_:  .asciiz " Exception 7 has been fixed\n\n"
...
# fix exception 7
	srl $a0 $k0 2		# Extract ExcCode Field
	andi $a0 $a0 0x1f
	bne $a0 7 bumpEPC	# bump EPC if not exception 7
	
	li $v0 4		# syscall 4 (print_str)
	la $a0 __m3_
	syscall

	lui $k0, 0x1001		# add base address 0x1001000 to $t1
	add $t1 $t1 $k0 
	j excp7_fixed		# skip bumping EPC
